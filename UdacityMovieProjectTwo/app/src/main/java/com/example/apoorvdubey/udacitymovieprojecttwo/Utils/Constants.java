package com.example.apoorvdubey.udacitymovieprojecttwo.Utils;
...
public class Constants {
    ...
    public static final String TOP_RATED_MOVIE="TOP RATED MOVIES";
    public static final String FAV_MOVIE="FAVOURITE MOVIES";
    public static final String POP_MOVIES="POPULAR MOVIES";
